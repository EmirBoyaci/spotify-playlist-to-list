...
const Form = ({ url, setUrl, setResponse }: FormProps) => {
  ...
  return (
    <>
      <form
        className="flex w-full flex-col items-center space-y-2 lg:flex-row lg:space-y-0 lg:space-x-2"
        onSubmit={onFormSubmit}
      >
        <input
          disabled={loading}
          type="url"
          className="w-full rounded-lg border border-gray-300 bg-gray-50 p-4 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
